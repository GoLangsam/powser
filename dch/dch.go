...
func (from *Dch) Receive() (val value, open bool) {
	if from.more() {
		select {
...
func (into *Dch) Send(val value) (sent bool) {
	select {
	case into.ch <- val:
		sent = true
		/*
